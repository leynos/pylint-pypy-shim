...
from tests.workflow_contracts.workflow_reading import jobs, scalars, uses_references

if typ.TYPE_CHECKING:
    from tests.workflow_contracts.workflow_reading import Document, Scalar
...
def token_sites(document: Document) -> list[str]:
    ...
    Examples
    --------
    >>> from tests.workflow_contracts.workflow_reading import load_document
    >>> body = "jobs:\n  a:\n    uses: x/y@z\n    secrets: inherit\n"
