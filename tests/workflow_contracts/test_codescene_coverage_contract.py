...
from tests.workflow_contracts.codescene_binding import binding_violations
from tests.workflow_contracts.codescene_publisher import (
...
from tests.workflow_contracts.codescene_reach import (
    COVERAGE_ACTION,
    pull_request_breaches,
    retired_names,
)
from tests.workflow_contracts.workflow_closure import (
    pull_request_surface,
    refused_references,
)
from tests.workflow_contracts.workflow_reading import (
    all_steps,
    read_workflow_tree,
    triggers,
)
...
if typ.TYPE_CHECKING:
    from tests.workflow_contracts.workflow_reading import Document
...
pytestmark = pytest.mark.skipif(
    ...
    reason=(
        "workflows not present in this working copy (for example inside "
