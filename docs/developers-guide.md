...
`tests/workflow_contracts/test_codescene_coverage_contract.py` holds the rule
over this repository's workflows. `test_codescene_closure_cases.py` and
...
it names. The readings live in `tests/workflow_contracts/`:
